...
describe('Nasdaq split unadjustment', () => {
  ...
  it('keeps named regression anchors for AAPL, TSLA, NVDA, AMZN, GOOG and GOOGL', () => {
    const anchors = [
      { name: 'AAPL 2020-08-28', adjusted: 124.8075, splits: [{ effectiveDate: '2020-08-31', numerator: 4, denominator: 1 }], raw: 499.23 },
      { name: 'TSLA 2020-08-28', adjusted: 147.56, splits: [{ effectiveDate: '2020-08-31', numerator: 5, denominator: 1 }, { effectiveDate: '2022-08-25', numerator: 3, denominator: 1 }], raw: 2213.4 },
      { name: 'TSLA 2022-08-24', adjusted: 297.09666667, splits: [{ effectiveDate: '2022-08-25', numerator: 3, denominator: 1 }], raw: 891.29000001 },
      { name: 'NVDA 2021-07-19', adjusted: 18.77975, splits: [{ effectiveDate: '2021-07-20', numerator: 4, denominator: 1 }, { effectiveDate: '2024-06-10', numerator: 10, denominator: 1 }], raw: 751.19 },
      { name: 'NVDA 2024-06-07', adjusted: 120.888, splits: [{ effectiveDate: '2024-06-10', numerator: 10, denominator: 1 }], raw: 1208.88 },
      { name: 'AMZN 2022-06-03', adjusted: 122.35, splits: [{ effectiveDate: '2022-06-06', numerator: 20, denominator: 1 }], raw: 2447 },
      { name: 'GOOG 2022-07-15', adjusted: 112.77, splits: [{ effectiveDate: '2022-07-18', numerator: 20, denominator: 1 }], raw: 2255.4 },
      { name: 'GOOGL 2022-07-15', adjusted: 111.7775, splits: [{ effectiveDate: '2022-07-18', numerator: 20, denominator: 1 }], raw: 2235.55 },
    ]
