...
export function GameProgressSheet(props: TimeControlProps) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="game-progress-backdrop" onMouseDown={(event) => { if (event.target === event.currentTarget) close() }}>
          <section className="game-progress-sheet" role="dialog" aria-modal="true" aria-labelledby="time-control-title" onKeyDown={handleDialogKeyDown}>
