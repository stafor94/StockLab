  ...
  return (
    <div className="event-modal-backdrop" role="presentation">
      <section className="event-modal" role="dialog" aria-modal="true" aria-label="중요 뉴스">
        <p className="section-kicker">중요 뉴스</p>
        <h2>{news.headline}</h2>
        ...
        <div className="important-news-actions"><button className="secondary-button" type="button" onClick={onOpenNews}>뉴스 보기</button><button className="primary-button" type="button" onClick={onConfirm}>확인</button></div>
      </section>
    </div>
  )
}
