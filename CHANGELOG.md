...
### Added
- 첫 실행에서 게임 목표, 시장 정보 경계, 시가 주문, 거래일 단계, 자동진행 중단 위험을 5단계로 안내하는 선택형 튜토리얼을 추가했습니다.
- 튜토리얼 완료·건너뛰기 상태를 보존하는 저장 스키마 v10 마이그레이션과 접근 가능한 모달 포커스 관리를 추가했습니다.

### Changed
- 튜토리얼이 열려 있는 동안 UI 자동진행만 정지하며 기존 결정론적 날짜 진행과 거래 규칙은 변경하지 않았습니다.
