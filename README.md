...
The committed market calendar remains a **bootstrap seed** until credentials and the private ticker mapping generate the full authoritative price dataset. Stock and FX histories are never fabricated. The base-rate file contains a small Bank of Korea-verified 2018 bootstrap. Corporate events and news currently use **empty schema-valid seeds** until authoritative historical datasets are assembled; fake events or articles are not inserted as placeholders.
