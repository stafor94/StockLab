export type AppIconName = 'home' | 'market' | 'portfolio' | 'news' | 'assets' | 'chevron' | 'settings' | 'star'
...
export function AppIcon({ name, size = 22, className }: AppIconProps) {
  ...
  if (name === 'star') return <svg {...common}><path d="m12 3 2.78 5.63 6.22.9-4.5 4.39 1.06 6.2L12 17.2l-5.56 2.92 1.06-6.2L3 9.53l6.22-.9Z"/></svg>
